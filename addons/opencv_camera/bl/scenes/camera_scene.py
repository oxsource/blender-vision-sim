...
Originally ``bl/scene_builder.py``; the behaviour and the object names are
unchanged so existing ``.blend`` files and scripts keep working.
"""
...
_CLASSES = (OPENCV_CAM_OT_add_camera_scene,)
